...
public class SearchBooksActivity2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        searchResultsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
                ...
                Intent intent = new Intent(SearchBooksActivity2.this, ViewBookActivity.class);
                        ...
                        timer.schedule(
                                new TimerTask() {
                                    ...
                                    public void run() {
                                        ...
                                        GoogleBooksSearchTask task = new GoogleBooksSearchTask(SearchBooksActivity2.this, adaptor);
                                        task.execute(query);
                                    }
                                },
                                DELAY
