...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void createBook(Book b){
        ...
        values.put(KEY_DATE_STARTED, b.getDateStarted());
        values.put(KEY_DATE_COMPLETED, b.getDateCompleted());
        values.put(KEY_DATE_TO_READ_BY, b.getDateToReadBy());
        values.put(KEY_DATE_PUBLISHED, b.getDatePublished());
        values.put(KEY_DATE_ADDED, b.getDateAdded());
    ...
    public ArrayList<Book> getAllMyBooks() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                book.setDateStarted(cursor.getString(7));
                book.setDateCompleted(cursor.getString(8));
                book.setDateToReadBy(cursor.getString(9));
                book.setDatePublished(cursor.getString(10));
                book.setDateAdded(cursor.getString(11));
